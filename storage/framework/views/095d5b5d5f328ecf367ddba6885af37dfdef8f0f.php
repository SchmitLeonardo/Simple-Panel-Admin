<?php if(Admin::user()->visible(\Illuminate\Support\Arr::get($item, 'roles', [])) && Admin::user()->can(\Illuminate\Support\Arr::get($item, 'permission'))): ?>
    ...
    <?php endif; ?>
<?php endif; ?><?php /**PATH /Users/leonardoschmidtborges/Documents/Projects/simple-admin-panel/vendor/encore/laravel-admin/src/../resources/views/partials/menu.blade.php ENDPATH**/ ?>